...
\section{The original POC}
	...
	\begin{frame}{Our solution: general principles}
		...
		\includesvg[width=200px]{img/svg/examples/infra-decision-tree}
	\end{frame}
...
\section{Deployment and new challenges}
	...
	\begin{frame}{Early 2025 : real data and first users}
		\begin{itemize}
			...
			\item We first focused on specific axis
	...
	\begin{frame}{Early 2025 : real data and first users}
		We had our first feedback!
		\begin{itemize}
			\item Too much false negative
			\item Data issues, with \textbf{specific} cases
		\end{itemize}
	\end{frame}
	
	\begin{frame}{2025 : Dealing with that feedback}
		TODO
	\end{frame}
...
\section{Conclusion}
	...
	\begin{frame}{What we've learned}
		\begin{itemize}
			\item The technical approach is sound, and could work on different infrastructures
			\item The hard part is the data quality, not just the algorithm
			\item There's a lot of people we need to convince
			\item We're always looking for collaborators, feedback, or other infrastructure managers interested in trying this
		\end{itemize}
	\end{frame}
