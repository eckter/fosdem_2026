...
\begin{frame}
	...
	\vspace{-1cm}
	\begin{center}
		{\textit{\footnotesize FOSDEM 2026\\Railways and Open Transport}}
	\end{center}
\end{frame}
...
\begin{frame}{OSRD (Open-Source Railway Designer)}
	...
	\end{itemize}
	\begin{center}
		$\vcenter{\hbox{\includesvg[height=30px]{img/svg/logos/osrd_small}}}$
		\hspace{0.5cm}
		$\vcenter{\hbox{\includesvg[height=20px]{img/svg/logos/sncf-reseau}}}$
		\vspace{0.5cm}\\
		\includegraphics[height=30px]{img/png/rust.png}
...
\section{Problem presentation}
	\begin{frame}{}
		\centering{\huge{\textbf{Problem presentation}}}
	\end{frame}
...
\section{The solution}
	...
	\begin{frame}{}
		\centering{\huge{\textbf{Our solution: general principles}}}
	\end{frame}
...
\section{Short demo}
	\begin{frame}{Short demo}
		\begin{block}{}
		Video available in the GitHub repo
		
		{\scriptsize \url{https://github.com/eckter/fosdem_2026/blob/master/short_demo.mkv}}
		\end{block}
	\end{frame}
...
\section{Deployment and new challenges}
	...
	\begin{frame}{}
		\centering{\huge{\textbf{Deployment and new challenges}}}
	\end{frame}
	\begin{frame}{How the new tool fits in the existing processes}
		\begin{block}{}
			People are already in charge of answering such requests: timetable planners
		\end{block}
		
		\includegraphics[scale=0.40]{img/png/interactions.png}
	\end{frame}
	
	\begin{frame}{2024 : real data}
		\begin{itemize}
	...
	\begin{frame}{2025 : feedback from timetable planners}
		\begin{itemize}
			\item Timetable planners noticed data issue with \textit{specific} examples.
...
\section{Conclusion}
	...
	\begin{frame}{Questions}
		...
		Github: {\footnotesize \url{https://github.com/OpenRailAssociation/osrd}}\\
